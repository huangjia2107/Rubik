...
namespace Rubik.Toolkit.AttachedProperties
{
    ...
    {
        public static readonly DependencyProperty RelativeVisibilityProperty = DependencyProperty.RegisterAttached("RelativeVisibility", typeof(Visibility), typeof(ElementProperty),
