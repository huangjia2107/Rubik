...
namespace Rubik.Theme
{
    ...
    {
        public static string LeftRightSplitterCur { get; } = @"/Rubik.Theme;component/Assets/Cursors/Splitter_lr.cur";
        public static string UpDownSplitterCur { get; } = @"/Rubik.Theme;component/Assets/Cursors/Splitter_ud.cur";
